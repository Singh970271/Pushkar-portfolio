...
import resume from '../media/Resume_pushkar.pdf';
                  ...
                  <Col lg={4} align='center'>
                    <Card className="nbcard">
                      <Card.Body>
                        ...
                        <br></br>
                        <a href="https://www.linkedin.com/in/pushkar-kumar-90a370233/" target="_blank" rel="noreferrer noopener">
                          <Button variant={darkMode ? "outline-light" : "outline-dark"} className='a'>
                            <FontAwesomeIcon className="dark" size="lg" icon={faLinkedin}/> Pushkar-Kumar
                          </Button>
                        </a>
                        <a href="https://github.com/Singh970271" target="_blank" rel="noreferrer noopener">
                          <Button variant={darkMode ? "outline-light" : "outline-dark"} className='a'>
                            <FontAwesomeIcon className="dark" size="lg" icon={faGithub}/> Pushkar-Kumar
                          </Button>
                        </a>
                        <br></br>
                        <br></br>
